...
#end
echo -en "[\e[0mOk\e[1;92m] Enter the Port number :"
read port
...
tput setaf 1; echo "                   ╱▔▔▔▔╲    
	 ...
	 ░█─── ▀█▀ ░█▄─░█ ░█─▄▀ ░█▀▀▀█
         ...
         ░█▄▄█ ▄█▄ ░█──▀█ ░█─░█ ░█▄▄▄█ " | lolcat 
		echo "	Please subscribe EFX Tv		" |toilet -f term -F border --gay
echo -e "[\e[0mOk\e[1;92m] The port you forwarded is here:👉 \e[0m\e[1;93m $port"
echo " "
#below lines can be sued for generating direct link.
ngrok_link=$(curl -s -N http://127.0.0.1:4040/api/tunnels | grep -o "tcp://[0-9a-z].tcp.ngrok.io:[0-9a-z][0-9a-z][0-9a-z][0-9a-z][0-9a-z]")
printf "\e[1;31m[\e[0m\e[1;37mOk\e[0m\e[1;31m]\e[0m\e[1;92m TCP Link :👉 \e[0m\e[1;93m %s \n" $ngrok_link
...
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] \e[0m\e[1;77m Press Ctrl + C to exit...\e[0m\n"
while [ true ]; do
